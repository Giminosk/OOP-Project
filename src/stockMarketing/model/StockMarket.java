...
public class StockMarket extends Market {
    ...
    public StockMarket(String name, Double fee, String symbol, Currency currency, String country, String city, String address ) {
        super(name, fee);
    ...
    public List<Index> getIndexList(){ return indexList;}
