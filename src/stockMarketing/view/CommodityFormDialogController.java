...
import stockMarketing.model.Commodity;
...
public class CommodityFormDialogController implements Initializable {
    ...
    public void setCommodityFields(Commodity commodity) {
        ...
        minPriceField.setText("" + (random-0.5));
        maxPriceField.setText("" + (random + 0.5));
    ...
    private void handleOk() {
        if(isInputValid()){
            ...
            if (type.equalsIgnoreCase("new")) {
                ...
                commodity.setMinPrice(random - 0.5);
                commodity.setMaxPrice(random + 0.5);
                commodity.setCurrentPrice(random);
                commodity.setVolume(randomInt);
                commodity.setCommoditiesCount(randomInt);
                commodity.setCommoditiesForSale(randomInt);
                commodity.setTurnoverValue(commodity.getCurrentPrice() * commodity.getVolume());
