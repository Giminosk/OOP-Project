...
public class ControlPanelController implements Initializable {
    ...
    @FXML
    private TableView<StockMarket> stockExchangeTable;
    @FXML
    private TableColumn<StockMarket, String> stockExchangeNameColumn;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        companySharesForSaleColumn.setCellValueFactory(cellData -> cellData.getValue().sharesForSaleProperty().asObject());
        ...
        commodityUnitsForSale.setCellValueFactory(cellData -> cellData.getValue().commoditiesForSaleProperty().asObject());       
    }    
    ...
    private void handleEditCurrency() {
        ...
        } else showAlert("Please select a Currency in the table.");
    }
    @FXML
    ...
    private void  handleNewStockExchange() {
        StockMarket tempStockExchange = new StockMarket();
    ...
    private void handleEditStockExchange() {
        StockMarket selectedStockExchange = stockExchangeTable.getSelectionModel().getSelectedItem();
        if (selectedStockExchange != null) {
            showStockExchangeFormDialog(selectedStockExchange);
        } else showAlert("Please select a StockExchange in the table.");
    }
    @FXML
    ...
    private void handleEditInvestor() {
        ...
        } else showAlert("Please select a Investor in the table.");
    }
    @FXML
    ...
    private void handleEditCommodity() {
        ...
        } else showAlert("Please select a Commodity in the table.");
    }
    @FXML
    ...
    public boolean showStockExchangeFormDialog(StockMarket stockMarket) {
        try {
            // Load the fxml file and create a new stage for the popup dialog.
            FXMLLoader loader = new FXMLLoader();
            ...
            controller.setDialogStage(dialogStage);
            controller.setApp(app);
            controller.setStockExchangeFields(stockMarket);
